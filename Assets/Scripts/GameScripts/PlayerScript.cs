	...
	*/
	...
	void Start () {
		...
		{			
			...
			portalGun.GetComponent<PortalLauncher>().canControl = false;
			hookGun.GetComponent<HookGunScript>().canControl = false;			
	...
	void Update () {
		...
		if(GM.GetComponent<GameSetup>().isPaused)
		{
			...
			portalGun.GetComponent<PortalLauncher>().enabled = false;
			transform.GetComponent<CharacterMotor>().enabled = false;
			transform.GetComponent<FPSInputController>().enabled = false;
			...
			portalGun.GetComponent<PortalLauncher>().enabled = true;
